...
export default function FinalPart(props) {
  ...
  const [openAlerts, setOpenAlert] = useState(false);
                ...
                {commentList.map((commentAssign, index) => {
                  ...
                  const userSelected =
                    commentAssign.USERId == studAssignment.USERId
                      ? studAssignment
                      : revisor;
                  const userSelectedInfo = userSelected.USER
                    ? userSelected.USER
                    : "";
                  ...
                  //   '';
                  const nameGeneral =
                    commentAssign.USER.name +
                    " " +
                    commentAssign.USER.fLastName +
                    " " +
                    commentAssign.USER.mLastName;
          ...
          >
            <div className="addComentsContainer">
              <div className="addCommentContainer">
                <label className="addCommenTitle" htmlFor="comment">
                  Comentario
                </label>
                <textarea
              ...
              <div className="addButtonContainer">
                ...
                {/* {openAlerts && (
                  <ModalsAlert
                    ...
                    alertText="¿Está seguro de enviar este comentario?"
                    messageText="Comentario enviado con éxito"
                    action={getCommentList}
                    item={null}
                  />
                )} */}
                {openMessage && (
                  <ModalsMessage closeMessage={setOpenMessage} 
