...
import { axiosDeleteCoordinators } from '../../../api/Specialty';

export default function ModalsAlertFacultyAdmin({ closeAlert, alertText, modalMessage, deleteList, setDeleteList}) {
        ...
        <div className="MAbody">
          ...
          <div className="MAfooter">
            <button
              className="MAaccept"
              onClick={() => {
                axiosDeleteCoordinators(JWTtoken, deleteList)
                .then((res) => {
                  console.log(res);
                })
                .catch((err) => {
