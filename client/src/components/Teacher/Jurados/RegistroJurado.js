...
import ModalsMessage from "../../Coordinator/Profesor/ModalsMessage";
...
function RegistroJurado() {
  ...
  return (
    <div>
      ...
      <div className="contenedorPrincipalRegister">
        ...
        >
          ...
          <div className="contenedorCambioPrincipalRegister">
            ...
            <div
              className="contenedorBotoneriaCambioPrincipalRegister"
      ...
      <div>
        {modalMensaje && (
          <ModalsMessage message="Se guardó el cambio correctamente" option={2}/>
        )}
        {loadChanges && (
          <ModalCargando
            estacargando={loadChanges}
            message={"Se está registrando su jurado..."}
          />
        )}
        {modalError && (
          <ModalValidacion
            closeMessage={setModalError}
            message={"Ha ocurrido un error al registrar el jurado"}
          />
        )}
