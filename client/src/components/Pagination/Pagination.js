...
export const Paginacion = ({pagina, setPagina, maximo, onClickHandler, setIsLoading}) =>  {
  ...
  const nextPage = () => {
    ...
    onClickHandler ? onClickHandler(parseInt(pagina) + 1) : (()=>{})();
  };
  ...
  return (
    <div className={styles.container}>
      ...
      <input
        ...
        defaultValue={pagina}
      />
      <div className='page-label'>de {maximo != 0 ? maximo : 1} </div>
      <button
