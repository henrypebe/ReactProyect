...
import ModalsMessageProfesor from "./Modals/ModalsMessageProfesor";
        ...
        >
          <div className="CoordHeader">
            <div className="CoordTitulo">
              <h1 style={{marginRight:"400px"}}>REGISTRO DE PROFESOR</h1>
            ...
            <div>
              ...
              {loadChanges && (
                <ModalCargando
                  ...
                  message={"Se está registrando su profesor..."}
                />
              )}
              {modalError && (
                <ModalValidacion
                  closeMessage={setModalError}
                  message={"Ha ocurrido un error al registrar el profesor"}
                />
              )}
