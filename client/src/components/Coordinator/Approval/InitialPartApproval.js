...
export default function InitialPartApproval() {
  ...
  const HabilitarClic = () => {
    if(fechaSeleccionadaFin > fechaSeleccionadaInicio) setHabilitado(!habilitado);
  ...
  const funcionBotonOpcion = () =>{
    if(habilitado) {
     ...
     onClick={() => {HabilitarClic(); handleHabilitarButton();}}
    >
      Habilitar</button>;
    }
    else {
      ...
      <div className="contenedorCuadroApproval">
        <div className="contenedorRangoFecha">
          <div className="enunciadoApproval">
            <p>
              Determinar el rango de fechas para la postulación de tema de tesis
            </p>
          </div>
          <div className="dosFilasApproval">
            <div className="primeraFilaApproval">
              ...
              <div className="DatePicker1InitialPartApproval">
                <MuiPickersUtilsProvider utils={DateFnsUtils} locale={esLocale}>
                  <DatePicker value={fechaSeleccionadaInicio} onChange={setFechaSeleccionadaInicio} 
                  format="dd/MM/yyyy" 
                  // minDate={new Date()}
                  disabled={!habilitado}/>
            ...
            <div className="segundaFilaApproval">
              ...
              <div className="DatePicker1InitialPartApproval">
                <MuiPickersUtilsProvider utils={DateFnsUtils} locale={esLocale}>
                  <DatePicker value={fechaSeleccionadaFin} onChange={setFechaSeleccionadaFin} 
                  format="dd/MM/yyyy" 
                  // minDate={new Date()}
                  disabled={!habilitado} />
                </MuiPickersUtilsProvider>
